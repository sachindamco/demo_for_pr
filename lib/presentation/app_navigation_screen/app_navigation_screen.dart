                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      _buildScreenTitle(
                        context,
                        screenTitle: "Member_Preference_unselected_screen",
                        onTapScreenTitle: () => onTapScreenTitle(
                            context, AppRoutes.genreSelectionScreen),
                      ),
                      _buildScreenTitle(
                        context,
                        screenTitle: "Events_listing_screen",
                        onTapScreenTitle: () => onTapScreenTitle(
                            context, AppRoutes.eventsDiscoveryScreen),
                      ),
                    ],
                  ),
                ),
